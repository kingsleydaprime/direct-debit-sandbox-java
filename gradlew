...
#   Important for users:
#
#   (2) This file is not a shell script you would normally want to run directly.
#       Instead, run this file with the gradlew command:
#           ./gradlew
#
##############################################################################
...
# This is reliable for all POSIX OSes.
